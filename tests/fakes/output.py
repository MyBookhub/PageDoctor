...
class FakeOutputPort:
    def __init__(self, fail_after: int | None = None, output_doc_id: str | None = None) -> None:
        ...
        self._output_doc_id = output_doc_id
    ...
    def write_findings(
        ...
        return OutputResult(output_doc_id=self._output_doc_id)
